...
var BasicViewDateProfileGenerator_1 = __webpack_require__(68);
var DayGrid_1 = __webpack_require__(66);
/* An abstract class for the "elements" views, as well as month view. Renders one or more rows of day cells.
----------------------------------------------------------------------------------------------------------------------*/
...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        var dayGridEl;
        this.el.addClass('fc-elements-view').html(this.renderSkeletonHtml());
...
var Component = /** @class */ (function (_super) {
    ...
    */
    // Renders the elements structure of the view before any content is rendered
    Component.prototype.renderSkeleton = function () {
        // subclasses should implement
    };
    // Unrenders the elements structure of the view
...
var ListView = /** @class */ (function (_super) {
    ...
    ListView.prototype.dayHeaderHtml = function (dayDate) {
        ...
        return '<tr class="fc-list-heading" data-date="' + dayDate.format('YYYY-MM-DD') + '">' +
            ...
            (mainFormat ?
                this.buildGotoAnchorHtml(dayDate, { 'class': 'fc-list-heading-dashboard' }, util_1.htmlEscape(dayDate.format(mainFormat)) // inner HTML
                ) :
                '') +
            (altFormat ?
...
var BasicView_1 = __webpack_require__(67);
var MonthView_1 = __webpack_require__(246);
ViewRegistry_1.defineView('elements', {
